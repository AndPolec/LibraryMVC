...
namespace LibraryMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230219181604_CorrectedCartName")]
    partial class CorrectedCartName
    {
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.Book", b =>
                {
                    ...
                    b.Property<int?>("BorrowingCartId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.Book", b =>
                {
                    ...
                    b.HasOne("LibraryMVC.Domain.Model.BorrowingCart", "BorrowingCart")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("LibraryMVC.Domain.Model.BorrowingCart", b =>
                {
                    b.HasOne("LibraryMVC.Domain.Model.User", "User")
                        ...
                        .HasForeignKey("LibraryMVC.Domain.Model.BorrowingCart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
